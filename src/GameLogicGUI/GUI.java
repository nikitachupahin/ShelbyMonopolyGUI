...
public class GUI implements UserInterface {
    ...
    public void changePropertyOwner(Property property, Player player) {
        ...
        waitForRequestRefresh();
    }

    private void waitForRequestRefresh() {
    ...
    public void showPlayerInfo(Player player) {
        this.displayMessage("Now player #" + player.getPlayerNum() + " " + player.getName() + " is at #" + player.getCoordinates().getCoord() + " " + player.getCoordinates().getName() + ".");
    }
